...
package cva6_hpdcache_subsystem_pkg;
  ...
  function automatic hpdcache_pkg::hpdcache_user_cfg_t hpdcacheSetUserConfig(
      config_pkg::cva6_cfg_t CVA6Cfg, int unsigned NumPorts);
    ...
    if (CVA6Cfg.NOCType == config_pkg::NOC_TYPE_L15_BIG_ENDIAN ||
        CVA6Cfg.NOCType == config_pkg::NOC_TYPE_L15_LITTLE_ENDIAN) begin
    ...
    userCfg.externalSram = CVA6Cfg.ExternalSram;
    return userCfg;
  endfunction
